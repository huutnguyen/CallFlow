...
var dataSetInfo;
var sankeySize = 0.9*window.innerHeight;
...
function splitNode2(){
	...
	success: function(newData){
	    ...
	    var histogramData = newData["histogramData"];
	    sankeyVis.updateData({"nodes" : remapResult["nodes"], "links" : remapResult["links"], "toolTipData" : newToolTipData, "histogramData" : histogramData, sankeySize: sankeySize});
	    if(showLabelBool == true){
		d3.selectAll('.node text').style('opacity', 1);
	    }
	    else{
